...
'''
This script takes any feature class that was created in the "true X" or "stacked"
...
if (len(sys.argv) > 1):
    ...
    in_fc = r'D:\DakotaSandModel\DakotaCrossSections\CrossSections.gdb\lixpys_2d_line'
    in_fc_etid_field = "et_id"
    system = "stacked"
    out_fc = r'D:\DakotaSandModel\DakotaCrossSections\CrossSections.gdb\qlixpys_line_trueY'
...
if shape == "Point":
    ...
    if true_x:
        ...
        printerror("!!ERROR!! Input file is already in True Y system. Proceeding will result in errors.")
            ...
            with arcpy.da.SearchCursor(in_fc, ['SHAPE@X', 'SHAPE@Y', unique_id_field], where_clause) as point_cursor:
                for point in point_cursor:
                    ...
                    if true_x:
                        ...
                        new_y = y * 3.280839895 / in_vertical_exaggeration
