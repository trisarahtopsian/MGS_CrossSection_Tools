...
"coordinate system" with true X coordinates and converts the feature class
to the true elevation coordinate system. Vertical exaggeration is created by 
compressing the x axis instead of stretching the y axis, the left extent of the
cross sections will start at zero instead of true UTM.
'''
...
if (len(sys.argv) > 1):
    ...
    in_fc = r'D:\DakotaSandModel\DakotaCrossSections\CrossSections091322.gdb\sgpg_lines_xsecview_trueX'
    in_fc_etid_field = "et_id"
    out_fc = r'D:\DakotaSandModel\DakotaCrossSections\CrossSections091322.gdb\sgpg_lines_xsecview_091322'
        ...
        for line in xsln_cursor:
            ...
            with arcpy.da.SearchCursor(in_fc, ['SHAPE@X', 'SHAPE@Y', unique_id_field], where_clause) as point_cursor:
                for point in point_cursor:
                    ...
                    new_x = new_x_raw/vertical_exaggeration*3.280839895
                    #remove VE from y coordinate and convert to meters
                    new_y = y*3.280839895/vertical_exaggeration
