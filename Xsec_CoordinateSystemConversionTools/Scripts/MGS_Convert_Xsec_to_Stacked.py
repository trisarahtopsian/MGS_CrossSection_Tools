...
'''
This script takes any feature class that was created in the "true Y" (traditional)
...
if (len(sys.argv) > 1):
    ...
    out_vertical_exaggeration = int(arcpy.GetParameterAsText(6)) #output vertical exaggeration
