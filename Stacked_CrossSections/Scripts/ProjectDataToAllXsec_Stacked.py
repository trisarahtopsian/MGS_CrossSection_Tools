...
if (len(sys.argv) > 1):
    ...
    out_fc = r'D:\QuatStrat_Editing\Stacked_Testing\project_to_all_xsec.gdb\poly_original_test_output1' #output fc with data projected onto desired cross sections
