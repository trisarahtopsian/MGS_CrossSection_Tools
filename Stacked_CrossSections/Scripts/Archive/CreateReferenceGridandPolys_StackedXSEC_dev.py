...
if (len(sys.argv) > 1):
    ...
    out_line_fc = arcpy.GetParameterAsText(10) #output line file
    out_poly_fc = arcpy.GetParameterAsText(11) #output polygon file
    ...
    xsln_file = r'D:\Chippewa_QuatStrat\CrossSections_Stacked.gdb\xsln' #mapview cross section line file
    xsln_id_field = 'et_id' #normally et_id
    out_line_fc = r'D:\Chippewa_QuatStrat\CrossSections_Stacked.gdb\grid_ref' #output line file
    out_poly_fc = r'D:\Chippewa_QuatStrat\CrossSections_Stacked.gdb\poly_ref'
...
output_dir = os.path.dirname(out_line_fc)
#get filename of output
output_name = os.path.basename(out_line_fc)
...
#get directory where output will be saved
output_dir = os.path.dirname(out_poly_fc)
#get filename of output
output_name = os.path.basename(out_poly_fc)
